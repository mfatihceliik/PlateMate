...
@RequestMapping("/api/admin/plate-removal-requests")
public interface IAdminPlateRemovalRequestController {

    @GetMapping
    ResponseEntity<DataResult<PagedData<PlateRemovalRequestDto>>> getRequests(
    ...
    ResponseEntity<Result> reviewRequest(
