...
If the task affects Android-visible API shape, response/request DTOs, authentication behavior, pagination, socket events, or client behavior, return to the root `AGENTS.md` first and follow the root full-stack workflow.

For Backend-only tasks, continue with this file and `Backend/platemate/docs/index.md`.
